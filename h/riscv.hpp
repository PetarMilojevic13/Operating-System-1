...
public:
   ...
   static void popSppSpie();
    ...
    static _Buffer* input_buffer;

    static _Buffer* output_buffer;

private:
    static void supervisorsyscallHandler();

    static void supervisorTimerHandler();

    static void supervisorOutsideInterruptHandler();
